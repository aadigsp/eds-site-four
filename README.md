...
## Environments
- Preview: https://main--eds-site-four--aadigsp.aem.page/
- Live: https://main--eds-site-four--aadigsp.aem.live/
...
1. Open the `eds-site-four` directory in your favorite IDE and start coding :)
